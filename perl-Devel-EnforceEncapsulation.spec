...
Requires: perl-Devel-EnforceEncapsulation-license
...
Group: Development
Provides: perl-Devel-EnforceEncapsulation-devel
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Devel-EnforceEncapsulation
cp LICENSE %{buildroot}/usr/share/doc/perl-Devel-EnforceEncapsulation/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Devel/EnforceEncapsulation.pm
